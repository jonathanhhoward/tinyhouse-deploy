...
const createBooking = (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const bookingsIndex = utils_2.resolveBookingsIndex(listing.bookingsIndex, checkIn, checkOut);
        const totalPrice = listing.price *
            ((checkOutDate.getTime() - checkInDate.getTime()) / utils_2.MILLISEC_PER_DAY + 1);
